...
alter table "public"."knowledge_base" add constraint "public_knowledge_base_topic_id_fkey" FOREIGN KEY (topic_id) REFERENCES topic(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."knowledge_base" validate constraint "public_knowledge_base_topic_id_fkey";

alter table "public"."knowledge_base" add constraint "public_knowledge_base_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."knowledge_base" validate constraint "public_knowledge_base_user_id_fkey";
...
-- Creating Trigger can sometimes fail which means we need to manually add the trigger;

create or replace trigger on_auth_user_created after insert on auth.users
for each row execute procedure public.handle_new_user();

alter table "public"."subject" add constraint "subject_user_id_fkey" FOREIGN KEY (user_id) REFERENCES profile(id) not valid;

alter table "public"."subject" validate constraint "subject_user_id_fkey";

alter table "public"."topic" add constraint "topic_user_id_fkey" FOREIGN KEY (user_id) REFERENCES profile(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
