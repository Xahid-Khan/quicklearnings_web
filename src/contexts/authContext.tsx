...
interface AuthModalContext {
  ...
  readonly fullScreenActivity: boolean;
  readonly setFullScreenActivity: Dispatch<SetStateAction<boolean>>;
}
...
export const AuthModalProvider = ({
  ...
  const [fullScreenActivity, setFullScreenActivity] = useState<boolean>(false);
